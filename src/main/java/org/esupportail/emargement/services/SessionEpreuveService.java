...
public class SessionEpreuveService {
    ...
    public boolean executeRepartition(Long sessionEpreuveId, String tagCheckOrder) {
        ...
        if (!possibleSepare && !possibleSansSalleTT) {
            log.info("PERF executeRepartition [seId={}] [outcome=isOver=true] [countTT={}] [countNonTT={}] [restantTT={}] [restantNonTT={}] [total={} ms]",
                    sessionEpreuveId, countTiers, countNonTiers, restantTiers, restantNonTiers,
        ...
        log.info("PERF executeRepartition [seId={}] [outcome=ok] [countTT={}] [countNonTT={}] [j_repartis={}] [order={}] [mode={}] [total={} ms]",
                sessionEpreuveId, countTiers, countNonTiers, j, tagCheckOrder,
                possibleSansSalleTT ? "ensemble" : "separe", System.currentTimeMillis() - startMs);
